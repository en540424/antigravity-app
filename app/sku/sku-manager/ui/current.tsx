// app/sku/sku-manager/ui/current.tsx
"use client";
...
export default function CurrentUI({ onEdit }: { onEdit?: (item: SkuItem) => void } = {}) {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-4">
      {/* ★ Tailwind 動作確認用 */}
      <div className="text-red-500 text-3xl mb-4">Tailwind TEST</div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
        {items.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="bg-white text-gray-900 rounded-xl p-5 shadow hover:shadow-md transition border"
            >
